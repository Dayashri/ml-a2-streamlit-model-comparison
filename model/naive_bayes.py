...
def save_trained_model(model, filename='naive_bayes_model.pkl'):
...
def main():
    ...
    print("=" * 60)
    print("NAIVE BAYES CLASSIFIER MODEL TRAINING")
    print("=" * 60)
    ...
    trained_model = train_naive_bayes_model(X_train, y_train)
