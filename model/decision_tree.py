...
def save_trained_model(model, filename='decision_tree_model.pkl'):
...
def main():
    ...
    print("=" * 60)
    print("DECISION TREE CLASSIFIER MODEL TRAINING")
    print("=" * 60)
    ...
    trained_model = train_decision_tree_model(X_train, y_train)
