...
def save_trained_model(model, filename='random_forest_model.pkl'):
...
def main():
    ...
    print("=" * 60)
    print("RANDOM FOREST ENSEMBLE MODEL TRAINING")
    print("=" * 60)
    ...
    print("\n✓ Random Forest ensemble model training complete!\n")
