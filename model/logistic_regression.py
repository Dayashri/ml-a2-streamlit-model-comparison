...
def train_logistic_model(X_train, y_train, max_iterations=1000):
    """Train Logistic Regression classifier"""
    log_reg_classifier = LogisticRegression(max_iter=max_iterations, random_state=42)
...
def save_trained_model(model, filename='logistic_regression_model.pkl'):
...
def main():
    ...
    trained_model = train_logistic_model(X_train, y_train)
