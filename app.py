...
def main():
    ...
    with st.sidebar:
        ...
        # ::: Code Generated by Copilot [7f3e9b42-1d6c-4a8f-9e7a-2c8b5f1a3d9e]. This comment will be removed automatically after the file is saved :::
        # Test data download
        st.subheader("Step 2: Download Test Data")
        
        # Load test CSV for download
        try:
            test_csv_path = "data/mushroom_test.csv"
            ...
            st.download_button(
                ...
                data=test_csv_data,
                file_name="mushroom_test.csv",
                mime="text/csv",
                help="Download this file to test the model evaluation"
            )
            st.success("Download test data to evaluate models")
        except FileNotFoundError:
            st.error("Test CSV file not found in data folder")
        
        # File upload
        st.subheader("Step 3: Upload Test Data")
